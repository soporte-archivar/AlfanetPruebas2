                        ...
                        <asp:Panel ID="Panel3" runat="server" CssClass="collapsePanelHeader" Width="99%" BackColor="Lavender" BorderColor="Red" BorderStyle="Solid" BorderWidth="3px">
                            ...
                            <div style="padding:5px; cursor: pointer; vertical-align: middle;">
                                ...
                                <div style="float: left; width: 400px; vertical-align: middle; color: activecaption; text-align: left; font: caption;">
                                    ...
                                    <asp:Label ID="Label19" runat="server" Font-Size="Smaller" Style="color:Black;">DOCUMENTOS VENCIDOS</asp:Label></div>
                                <div style="float: left; margin-left: 20px;">
...
<asp:HiddenField ID="Label60" runat="server" Value='<%# Bind("NumeroDocumento") %>' Visible="false" />
...
<asp:Image id="ImgDocNotasExtVen" runat="server" Width="25px" Visible="false" ImageUrl="~/AlfaNetImagen/ToolBar/VerPostIt.gif"  Height="25px" CssClass="PointerCursor" __designer:wfdid="w1"></asp:Image>
    ...
    </asp:Panel> <ajaxToolkit:HoverMenuExtender id="HoverMenuExtender3" runat="server" TargetControlID="ImgDocNotasExtVen" PopupControlID="PnlNotasDocExtven" __designer:wfdid="w4">
...
<dxwgv:GridViewDataTextColumn FieldName="MedioCodigo" Width="12px" Caption="Rpta" VisibleIndex="7"><DataItemTemplate>
<asp:ImageButton id="ImageButton3" runat="server" ToolTip="Respuesta AlfaNet" ImageUrl="~/AlfaNetImagen/ToolBar/reply.gif" CssClass="PointerCursor" PostBackUrl="javascript:void(0);"></asp:ImageButton> <BR /><asp:Image id="imgRptaExt" runat="server" Width="15px" Visible="false" ToolTip="Respuesta Externa" ImageUrl="~/AlfaNetImagen/ToolBar/icono_enviada.gif" Height="12px" CssClass="PointerCursor"></asp:Image> <asp:RegularExpressionValidator id="RegularExpressionValidator1" runat="server" ValidationGroup="CreateUserWizard1" SetFocusOnError="True" ControlToValidate="txtRptaExt" ErrorMessage="revRptaExt" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">Email Invalido
</asp:RegularExpressionValidator> <ajaxToolkit:PopupControlExtender id="pceRptaExt" runat="server" TargetControlID="imgRptaExt" PopupControlID="pnlRptaExt" Position="Right">
</ajaxToolkit:PopupControlExtender> <asp:HiddenField id="hfMedio" runat="server" Value='<%# Bind("MedioCodigo") %>'></asp:HiddenField> <asp:Panel style="LEFT: 3px" id="pnlRptaExt" runat="server" Width="220px" Height="60px" CssClass="popupMenu"><asp:TextBox id="txtRptaExt" runat="server" Width="200px" Height="10px" CssClass="RecuadroEmergente"></asp:TextBox> <BR /></asp:Panel> 
</DataItemTemplate>
...
<asp:HiddenField id="HFCargar" runat="server" __designer:wfdid="w1"></asp:HiddenField> <asp:TextBox id="TxtCargarDocVen" runat="server" oncopy = "return false" onpaste = "return false" oncut = "return false" Width="152px" Font-Size="9pt" Height="15px" Enabled="False" CssClass="TextBoxStyleGrid" __designer:wfdid="w2"></asp:TextBox>
    <asp:TextBox id="TxtCargarDocVenSerie" style="display:none" runat="server" oncopy = "return false" onpaste = "return false" oncut = "return false" Width="152px" Font-Size="9pt" Height="15px" Enabled="false" __designer:wfdid="w2"></asp:TextBox>
     <asp:Panel style="LEFT: 213px; TOP: 132px" id="PnlCargarDocVen" runat="server" Width="380px" Height="300px" CssClass="popupControl" HorizontalAlign="Left" __designer:wfdid="w3" ScrollBars="Both"><DIV><asp:TreeView id="TreeVDependencia" runat="server" Width="300px" __designer:wfdid="w4" ExpandDepth="0" OnTreeNodePopulate="TreeVDependencia_TreeNodePopulate">
...
</asp:TreeView> <asp:TreeView id="TreeVSerie" runat="server" __designer:wfdid="w5" ExpandDepth="0" OnTreeNodePopulate="TreeVSerie_TreeNodePopulate">
<Nodes>
...
<asp:TextBox id="TxtAccionDocExtVen" runat="server" Width="139px" Font-Size="9pt" Height="15px" Enabled="False" CssClass="TextBoxStyleGrid" __designer:wfdid="w19"></asp:TextBox> <ajaxToolkit:AutoCompleteExtender id="AutoCompleteExtender1" runat="server" TargetControlID="TxtAccionDocExtVen" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetWFAccionTextByText" MinimumPrefixLength="-1" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" __designer:wfdid="w20">
                        ...
                        <asp:Panel ID="Panel5" runat="server" CssClass="collapsePanelHeader" Width="99%" BorderColor="Yellow" BorderStyle="Solid" BorderWidth="3px" BackColor="Lavender">
                            <div style="padding:5px; cursor: pointer; vertical-align: middle;">
                                ...
                                <div style="float: left; width: 400px; vertical-align: middle; color: activecaption; text-align: left; font: caption;">
                                    ...
                                    <asp:Label ID="Label21" runat="server" Font-Size="Smaller" Style="color:Black;">DOCUMENTOS PROXIMOS A VENCER</asp:Label></div>
                                <div style="float: left; margin-left: 20px;">
...
<asp:HiddenField id="HFCargar" runat="server" __designer:wfdid="w9"></asp:HiddenField> <asp:TextBox id="TxtCargarDocVen" runat="server" oncopy = "return false" onpaste = "return false" oncut = "return false" Width="152px" Font-Size="9pt" Height="15px" Enabled="False" CssClass="TextBoxStyleGrid" __designer:wfdid="w10"></asp:TextBox> 
    <asp:TextBox id="TxtCargarDocVenSerie" style="display:none" runat="server" oncopy = "return false" onpaste = "return false" oncut = "return false" Width="152px" Font-Size="9pt" Height="15px" Enabled="false" __designer:wfdid="w2"></asp:TextBox>
    <asp:Panel style="LEFT: 213px; TOP: 132px" id="PnlCargarDocVen" runat="server" Width="380px" Height="300px" CssClass="popupControl" HorizontalAlign="Left" __designer:wfdid="w11" ScrollBars="Both"><DIV><asp:TreeView id="TreeVDependencia" runat="server" Width="350px" __designer:wfdid="w12" ExpandDepth="0" OnTreeNodePopulate="TreeVDependencia_TreeNodePopulate">
<Nodes>
<asp:TreeNode Expanded="False" PopulateOnDemand="True" SelectAction= "None" Text=" Seleccione Dependencia..." Value="0"></asp:TreeNode>
                </Nodes>
...
<NodeStyle Width="230px" ChildNodesPadding="10px" Font-Bold="False" Font-Size="8pt" ForeColor="Black"></NodeStyle>
        ...
        <SelectedNodeStyle ForeColor="Black" />
            </asp:TreeView> <asp:TreeView id="TreeVSerie" runat="server" __designer:wfdid="w13" ExpandDepth="0" OnTreeNodePopulate="TreeVSerie_TreeNodePopulate">
<Nodes>
<asp:TreeNode PopulateOnDemand="True" SelectAction="None" Text="Seleccione Archivar..." Value="0"></asp:TreeNode>
                </Nodes>
                <ParentNodeStyle Font-Bold="True" />
    ...
    <NodeStyle Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" HorizontalPadding="5px"
        NodeSpacing="0px" VerticalPadding="0px" />
                <LeafNodeStyle ForeColor="Black" />
            </asp:TreeView> </DIV></asp:Panel> <ajaxToolkit:AutoCompleteExtender id="ACECargarDocEnv" runat="server" Enabled="True" TargetControlID="TxtCargarDocVen" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetDependenciaByText" MinimumPrefixLength="-1" CompletionInterval="100" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" __designer:wfdid="w15"></ajaxToolkit:AutoCompleteExtender> <ajaxToolkit:PopupControlExtender id="PCECargarDocEnv" runat="server" TargetControlID="TxtCargarDocVen" PopupControlID="PnlCargarDocVen" __designer:wfdid="w16" OffsetY="25" OffsetX="-380"></ajaxToolkit:PopupControlExtender>
                        ...
                        <asp:Panel ID="Panel7" runat="server" CssClass="collapsePanelHeader" Width="99%" BorderColor="Green" BorderStyle="Solid" BorderWidth="3px" BackColor="Lavender">
                            <div style="padding:5px; cursor: pointer; vertical-align: middle;">
                                ...
                                <div style="float: left; width: 400px; vertical-align: middle; color: activecaption; text-align: left; font: caption;">
                                    ...
                                    <asp:Label ID="Label24" runat="server" Font-Size="Smaller" Style="color:Black;">DOCUMENTOS PENDIENTES</asp:Label></div>
                                <div style="float: left; margin-left: 20px;">
...
<dxwgv:GridViewDataTextColumn Width="145px" Caption="Cargar a:" VisibleIndex="10"><DataItemTemplate>
<asp:HiddenField id="HFCargar" runat="server" __designer:wfdid="w17"></asp:HiddenField> <asp:TextBox id="TxtCargarDocVen" runat="server" oncopy = "return false" onpaste = "return false" oncut = "return false" Width="152px" Font-Size="9pt" Height="15px" Enabled="False" CssClass="TextBoxStyleGrid" __designer:wfdid="w18"></asp:TextBox>
    <asp:TextBox id="TxtCargarDocVenSerie" style="display:none" runat="server" oncopy = "return false" onpaste = "return false" oncut = "return false" Width="152px" Font-Size="9pt" Height="15px" Enabled="false" __designer:wfdid="w2"></asp:TextBox>
     <asp:Panel style="LEFT: 213px; TOP: 132px" id="PnlCargarDocVen" runat="server" Width="380px" Height="300px" CssClass="popupControl" HorizontalAlign="Left" __designer:wfdid="w19" ScrollBars="Both"><DIV><asp:TreeView id="TreeVDependencia" runat="server" Width="350px" __designer:wfdid="w20" ExpandDepth="0" OnTreeNodePopulate="TreeVDependencia_TreeNodePopulate">
<Nodes>
<asp:TreeNode Expanded="False" PopulateOnDemand="True" SelectAction= "None" Text=" Seleccione Dependencia..." Value="0"></asp:TreeNode>
                </Nodes>
...
<NodeStyle Width="230px" ChildNodesPadding="10px" Font-Bold="False" Font-Size="8pt" ForeColor="Black"></NodeStyle>
        ...
        <HoverNodeStyle Font-Bold="False" ForeColor="Black" />
        <SelectedNodeStyle ForeColor="Black" />
            </asp:TreeView> <asp:TreeView id="TreeVSerie" runat="server" __designer:wfdid="w21" ExpandDepth="0" OnTreeNodePopulate="TreeVSerie_TreeNodePopulate">
<Nodes>
<asp:TreeNode PopulateOnDemand="True" SelectAction="None" Text="Seleccione Archivar..." Value="0"></asp:TreeNode>
                </Nodes>
                <ParentNodeStyle Font-Bold="True" />
    ...
    <NodeStyle Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" HorizontalPadding="5px"
        NodeSpacing="0px" VerticalPadding="0px" />
                <LeafNodeStyle ForeColor="Black" />
            </asp:TreeView> </DIV></asp:Panel> <ajaxToolkit:AutoCompleteExtender id="ACECargarDocEnv" runat="server" Enabled="True" TargetControlID="TxtCargarDocVen" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetDependenciaByText" MinimumPrefixLength="-1" CompletionInterval="100" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" __designer:wfdid="w23"></ajaxToolkit:AutoCompleteExtender> <ajaxToolkit:PopupControlExtender id="PCECargarDocEnv" runat="server" TargetControlID="TxtCargarDocVen" PopupControlID="PnlCargarDocVen" __designer:wfdid="w24" OffsetY="25" OffsetX="-380"></ajaxToolkit:PopupControlExtender>
    <ajaxToolkit:AutoCompleteExtender id="ACECargarDocEnvSerie" runat="server" TargetControlID="TxtCargarDocVenSerie" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetSubSerieByText" MinimumPrefixLength="-1" CompletionInterval="100" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" __designer:wfdid="w7"></ajaxToolkit:AutoCompleteExtender>
     <ajaxToolkit:PopupControlExtender id="PCECargarDocEnvSerie" runat="server" TargetControlID="TxtCargarDocVenSerie" PopupControlID="PnlCargarDocVen" __designer:wfdid="w8" Position="Center" OffsetY="25" OffsetX="-380"></ajaxToolkit:PopupControlExtender> 
</DataItemTemplate>
            ...
            <div style="padding:5px; cursor: pointer; vertical-align: middle;">
                ...
                <div style="float: left; width: 400px; vertical-align: middle; color: activecaption; text-align: left; font: caption;">
                    &nbsp;<asp:Label ID="Label25" runat="server" Font-Size="Smaller" Style="color:Black;">USTED TIENE</asp:Label>&nbsp;<asp:Label ID="LblDocRecCopia" runat="server" Font-Bold="False"
                        Font-Size="Larger" Height="20px" Style="font: caption; color:Black; vertical-align: bottom;
                        text-align: center" Width="25px">#</asp:Label>&nbsp; 
                    <asp:Label ID="Label26" runat="server" Font-Size="Smaller" Style="color:Black;">DOCUMENTOS COPIA</asp:Label></div>
                <div style="float: left; margin-left: 20px;">
...
<asp:TextBox id="TxtDocNotasExtVen" runat="server" Width="400px" BackColor="#FDFA8F" Text='<%# Bind("WFMovimientoNotas") %>' Height="100px"
 BorderStyle="None" TextMode="MultiLine" __designer:wfdid="w3" Enabled="False"></asp:TextBox> </asp:Panel> <ajaxToolkit:HoverMenuExtender id="HoverMenuExtender3" runat="server" TargetControlID="ImgDocNotasExtVen" PopupControlID="PnlNotasDocExtven" __designer:wfdid="w4">
    </ajaxToolkit:HoverMenuExtender> <ajaxToolkit:PopupControlExtender id="PCEDocNotasExtVen" runat="server" Enabled="False" TargetControlID="ImgDocNotasExtVen" PopupControlID="PnlNotasDocExtven" __designer:wfdid="w5">
                                            </ajaxToolkit:PopupControlExtender> 
</DataItemTemplate>
...
</ajaxToolkit:PopupControlExtender> <asp:HiddenField id="hfMedio" runat="server"></asp:HiddenField> <asp:Panel style="LEFT: 3px" id="pnlRptaExt" runat="server" Width="220px" Height="60px" CssClass="popupMenu"><asp:TextBox id="txtRptaExt" runat="server" Width="200px" Height="10px" CssClass="RecuadroEmergente"></asp:TextBox> <BR /></asp:Panel> 
</DataItemTemplate>
        ...
        SuppressPostBack="true"/>
                ...
                <asp:Panel ID="Panel16" runat="server" CssClass="collapsePanelHeader" BackImageUrl="~/AlfaNetImagen/MainMaster/bg-menu-main.png" style="vertical-align: top; text-align: left" Width="100%">
                    ...
                    <div style="padding:5px; cursor: pointer; vertical-align: middle;">
                        ...
                        <div style="float: left; margin-left: 20px;">
                            <asp:Label ID="Label13" runat="server" Font-Size="Smaller" Height="20px" Style="vertical-align: middle; color:White;
                ...
                <asp:Panel ID="Panel12" runat="server" CssClass="collapsePanelHeader" Width="99%" BorderColor="SlateBlue" BorderStyle="Solid" BorderWidth="3px" BackColor="Lavender">
                    ...
                    <div style="padding:5px; cursor: pointer; vertical-align: middle;">
                        ...
                        <div style="float: left; width: 400px; vertical-align: middle; color: activecaption; text-align: left; font: caption;">
                            ...
                            <asp:Label ID="Label28" runat="server" Font-Size="Smaller" Style="color:Black;">DOCUMENTOS COPIA EXTERNOS</asp:Label></div>
                        <div style="float: left; margin-left: 20px;">
...
<dxwgv:GridViewDataTextColumn FieldName="RegistroDetalle" Width="14px" Caption="Detalle" VisibleIndex="7">
<Settings AutoFilterCondition="Contains"></Settings>
<DataItemTemplate>
                    ...
                    <div style="padding:5px; cursor: pointer; vertical-align: middle;">
                        ...
                        <div style="float: left; margin-left: 20px;">
                            <asp:Label ID="Label15" runat="server" Font-Size="Smaller" Height="20px" Style="vertical-align: middle;
                                text-align: left; color:White;"  Width="180px">(Ver Detalles...)</asp:Label>
                        </div>
                        ...
                        <div style="padding:5px; cursor: pointer;">
                            ...
                            <div style="float: left; vertical-align: middle; color: Black; text-align: left; font: caption; width: 400px; font-size: 14px; font-weight: normal;">
                                &nbsp;USTED TIENE &nbsp;<asp:Label ID="LblDocEnvIntVen" runat="server" Font-Bold="False"
                                    Font-Size="Larger" Style="font: caption; vertical-align: bottom; color:Black;
...
<dxwgv:GridViewDataTextColumn FieldName="RegistroDetalle" Width="14px" Caption="Detalle" VisibleIndex="8">
<Settings AutoFilterCondition="Contains"></Settings>
<DataItemTemplate>
...
<asp:HiddenField id="HFCargar" runat="server" __designer:wfdid="w25"></asp:HiddenField> <asp:TextBox id="TxtCargarDocVen" runat="server" oncopy = "return false" onpaste = "return false" oncut = "return false" Width="161px" Font-Size="X-Small" Enabled="False" CssClass="TextBoxStyleGrid" __designer:wfdid="w26"></asp:TextBox>
<asp:TextBox id="TxtCargarDocVenSerie" style="display:none" runat="server" oncopy = "return false" onpaste = "return false" oncut = "return false" Width="152px" Font-Size="9pt" Height="15px" Enabled="false" __designer:wfdid="w2"></asp:TextBox>
     <asp:Panel id="PnlCargarDocVen" runat="server" Width="385px" Height="300px" CssClass="popupControl" HorizontalAlign="Left" __designer:wfdid="w27" ScrollBars="Both"><DIV><asp:TreeView id="TreeVDependencia" runat="server" __designer:wfdid="w28" OnTreeNodePopulate="TreeVDependencia_TreeNodePopulate" ExpandDepth="0" ShowLines="True">
                                                    <ParentNodeStyle Font-Bold="True" />
                                                    <HoverNodeStyle Font-Underline="True" />
                                                    <SelectedNodeStyle Font-Underline="True" HorizontalPadding="0px" VerticalPadding="0px" />
                                                    <Nodes>
                                                ...
                                                </asp:TreeView> <asp:TreeView id="TreeVFinalizar" runat="server" __designer:wfdid="w29" OnTreeNodePopulate="TreeVSerie_TreeNodePopulate" ExpandDepth="0" ShowLines="True">
                                                    <ParentNodeStyle Font-Bold="True" />
                                                    <HoverNodeStyle Font-Underline="True" />
                                                    <SelectedNodeStyle Font-Underline="True" HorizontalPadding="0px" VerticalPadding="0px" />
                                                    <Nodes>
                                        ...
                                        </ajaxToolkit:AutoCompleteExtender> <ajaxToolkit:PopupControlExtender id="PCECargarDocEnv" runat="server" TargetControlID="TxtCargarDocVen" PopupControlID="PnlCargarDocVen" __designer:wfdid="w32" OffsetY="25" OffsetX="-380"></ajaxToolkit:PopupControlExtender>
    <ajaxToolkit:AutoCompleteExtender id="ACECargarDocEnvSerie" runat="server" TargetControlID="TxtCargarDocVenSerie" ServicePath="../../AutoComplete.asmx" ServiceMethod="GetSubSerieByText" MinimumPrefixLength="-1" CompletionInterval="100" CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" __designer:wfdid="w7"></ajaxToolkit:AutoCompleteExtender>
     <ajaxToolkit:PopupControlExtender id="PCECargarDocEnvSerie" runat="server" TargetControlID="TxtCargarDocVenSerie" PopupControlID="PnlCargarDocVen" __designer:wfdid="w8" Position="Center" OffsetY="25" OffsetX="-380"></ajaxToolkit:PopupControlExtender> 
</DataItemTemplate>
...
<dxwgv:GridViewDataTextColumn Width="149px" Caption="Acci&#243;n:" VisibleIndex="11"><DataItemTemplate>
    <asp:TextBox ID="TxtAccionDocExtVen" runat="server" CssClass="TextBoxStyleGrid" Font-Size="X-Small" Width="145px" Enabled="False"></asp:TextBox>
                                        <ajaxToolkit:AutoCompleteExtender
                                                ID="AutoCompleteExtender5" runat="server" CompletionInterval="100" MinimumPrefixLength="-1"
...
<ProgressBar Height="25px"></ProgressBar>
        ...
        ExpandedImage="~/AlfaNetImagen/MainMaster/collapse_blue.jpg"
        CollapsedImage="~/AlfaNetImagen/MainMaster/expand_blue.jpg"/>
                    <asp:Panel ID="Panel10" runat="server" CssClass="collapsePanelHeader" Width="99%" Height="50px" BorderColor="SlateBlue" BorderStyle="Solid" BorderWidth="3px" BackColor="Lavender">
            <div style="padding:5px; cursor: pointer; vertical-align: middle;">
                <div style="float: left">
                    <img src="../../AlfaNetImagen/ToolBar/wfcopias.gif" height="14" width="14" />&nbsp;</div>
