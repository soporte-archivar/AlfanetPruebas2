    ...
    protected void escriba(DataRow[] rows)
    {
        ...
        foreach (DSRegistro.Registro_ConsultasHistoricoRow DRRegHis in rows)
        {
            if (i % 2 != 0)
            {
                ...
                if (DRRegHis.WFMovimientoNotas != "" && DRRegHis.WFMovimientoNotas != null)
                {
                    ...
                    LbPasoPostIt.Text = DRRegHis.WFMovimientoNotas;
                ...
                */
                ...
                if (DRRegHis.WFMovimientoNotas != "" && DRRegHis.WFMovimientoNotas != null)
                {
                   // HtmlTableCell Cell01a = new HtmlTableCell();
                    ...
                    LbPasoPostIt1.Text = DRRegHis.WFMovimientoNotas;
