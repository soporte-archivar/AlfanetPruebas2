...
<asp:HiddenField id="HFCargar" runat="server" __designer:wfdid="w1"></asp:HiddenField> <asp:TextBox id="TxtCargarDocVen" runat="server" Width="152px" Font-Size="9pt" Height="15px" Enabled="False" CssClass="TextBoxStyleGrid" __designer:wfdid="w2"></asp:TextBox> <asp:Panel style="LEFT: 213px; TOP: 132px" id="PnlCargarDocVen" runat="server" Width="380px" Height="300px" CssClass="popupControl" HorizontalAlign="Left" __designer:wfdid="w3" ScrollBars="Both"><DIV><asp:TreeView id="TreeVDependencia" runat="server" Width="300px" __designer:wfdid="w4" ExpandDepth="0" OnTreeNodePopulate="TreeVDependencia_TreeNodePopulate">
...
<asp:HiddenField id="HFCargar" runat="server" __designer:wfdid="w9"></asp:HiddenField> <asp:TextBox id="TxtCargarDocVen" runat="server" Width="152px" Font-Size="9pt" Height="15px" Enabled="False" CssClass="TextBoxStyleGrid" __designer:wfdid="w10"></asp:TextBox> <asp:Panel style="LEFT: 213px; TOP: 132px" id="PnlCargarDocVen" runat="server" Width="380px" Height="300px" CssClass="popupControl" HorizontalAlign="Left" __designer:wfdid="w11" ScrollBars="Both"><DIV><asp:TreeView id="TreeVDependencia" runat="server" Width="350px" __designer:wfdid="w12" ExpandDepth="0" OnTreeNodePopulate="TreeVDependencia_TreeNodePopulate">
<Nodes>
<asp:TreeNode Expanded="False" PopulateOnDemand="True" SelectAction= "None" Text=" Seleccione Dependencia..." Value="0"></asp:TreeNode>
                </Nodes>
...
<dxwgv:GridViewDataTextColumn Width="145px" Caption="Cargar a:" VisibleIndex="10"><DataItemTemplate>
<asp:HiddenField id="HFCargar" runat="server" __designer:wfdid="w17"></asp:HiddenField> <asp:TextBox id="TxtCargarDocVen" runat="server" Width="152px" Font-Size="9pt" Height="15px" Enabled="False" CssClass="TextBoxStyleGrid" __designer:wfdid="w18"></asp:TextBox> <asp:Panel style="LEFT: 213px; TOP: 132px" id="PnlCargarDocVen" runat="server" Width="380px" Height="300px" CssClass="popupControl" HorizontalAlign="Left" __designer:wfdid="w19" ScrollBars="Both"><DIV><asp:TreeView id="TreeVDependencia" runat="server" Width="350px" __designer:wfdid="w20" ExpandDepth="0" OnTreeNodePopulate="TreeVDependencia_TreeNodePopulate">
<Nodes>
<asp:TreeNode Expanded="False" PopulateOnDemand="True" SelectAction= "None" Text=" Seleccione Dependencia..." Value="0"></asp:TreeNode>
                </Nodes>
...
<asp:HiddenField id="HFCargar" runat="server" __designer:wfdid="w25"></asp:HiddenField> <asp:TextBox id="TxtCargarDocVen" runat="server" Width="161px" Font-Size="X-Small" Enabled="False" CssClass="TextBoxStyleGrid" __designer:wfdid="w26"></asp:TextBox> <asp:Panel id="PnlCargarDocVen" runat="server" Width="385px" Height="300px" CssClass="popupControl" HorizontalAlign="Left" __designer:wfdid="w27" ScrollBars="Both"><DIV><asp:TreeView id="TreeVDependencia" runat="server" __designer:wfdid="w28" OnTreeNodePopulate="TreeVDependencia_TreeNodePopulate" ExpandDepth="0" ShowLines="True">
                                                    <ParentNodeStyle Font-Bold="True" />
                                                    <HoverNodeStyle Font-Underline="True" />
                                                    <SelectedNodeStyle Font-Underline="True" HorizontalPadding="0px" VerticalPadding="0px" />
                                                    <Nodes>
            ...
            <div style="padding:5px; cursor: pointer; vertical-align: middle;">
                ...
                <div style="float: left; width: 400px; vertical-align: middle; color: activecaption; text-align: left; font: caption;">
                    &nbsp;USTED TIENE &nbsp;<asp:Label ID="LblDocCopiaInt" runat="server" Font-Bold="False" Font-Size="Larger"
                        Height="20px" Style="font: caption; vertical-align: bottom; text-align: center"
                        Width="25px">#</asp:Label>&nbsp; DOCUMENTOS ENVIADOS INTERNOS COPIA</div>
                <div style="float: left; margin-left: 20px;">
