    ...
    <table width="100%">
        <tr>
            <td style="vertical-align: top; text-align: center">
                <br />
                        <img src="../../AlfaNetImagen/Logo/Logo Empresa.jpg" Width="250px" height = "180px" style="margin-right:40px; margin-bottom:40px; "/><br />
            </td>
            <td style="vertical-align: top; text-align: center">
        ...
        <tr>
            <td style="vertical-align: bottom; text-align: float; height: 22px;" align="left">
                <asp:Label ID="Label1" runat="server" BackColor="#336699" BorderColor="Black"
                    BorderWidth="1px" Font-Bold="False" ForeColor="White" Text="Licenciado a:"  Font-Size="Small" ></asp:Label>
