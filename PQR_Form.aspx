...
<body id="content">
    <form id="form1" runat="server" enctype="multipart/form-data" method="post">
	 ...
	 <tr>
        ...
        <table width="100%">
            <tr>
                <td style="width: 30%"><span style="color: red;">*</span><asp:Label ID="etTipoIdentificacion" runat="server" Text="Tipo de número" EnableViewState="False" Font-Size="9pt"></asp:Label></td>
                <td style="width: 45%">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td style="text-align: left; font-size: 12px; width: 45%;">
                    ...
                    <asp:Label ID="etMaximoCaracteres" runat="server" Text="0"></asp:Label>, <span>máximo
                            300 caracteres</span>
                </td>
                <td style="width: 35%">
