...
public partial class AlfanetDocumentos_DocRecibido_NuevoDocRecibido1 : System.Web.UI.Page
{
    string GrpDocRad = "1";
    ...
    protected void Radicar()
    {
        try
        {
            ...
            if (this.HFCargar.Value == "Dependencia" || this.HFCargar.Value == "")
            {
                ...
                int radicado = Convert.ToInt32(RadicadoCodigo);
                Radi = Radicado.GetData(radicado);
                string Detalle = Radi.Rows[0].ItemArray[0].ToString().Trim();
                if (DTUsuariosxDependencia.Count > 0)
                {
                    ...
                    string Body = "Tiene un nuevo Radicado Nro " + RadicadoCodigo + "<BR>" + " Fecha de Radicacion: " + DateTime.Now.ToLongDateString() + " " + DateTime.Now.ToLongTimeString() + "<BR>" + "Procedencia: " + TxtProcedencia.Text.ToString() + "<BR>" + "Naturaleza: " + TxtNaturaleza.Text.ToString().Trim() + "<BR>" + "Detalle: " + Detalle + "<BR>";
                ...
                DTProcedencia = TAProcedencias.GetProcedenciaIdV2DataBy(ProCod.Trim().ToString(), "CC");
                ...
                if (DTProcedencia.Rows.Count == 1)
                {
                    ...
                    "<a href=" + "https://www.fbscgr.gov.co/tools/marco.php?idcategoria=3941" + ">" + "Consultar" + "</a>" +
                    "<BR>" +"<BR>" +
                    "Nota: favor no responder este correo, este medio solo es utilizado para informar sobre su trámite ante el Fondo.";                    
                    Correo.EnvioCorreo("gestiondocumental@fbscgr.gov.co", EmailProc, "Radicado Nro" + " " + RadicadoCodigo, Body, true, "1");
