...
public partial class ImportarDatos : System.Web.UI.Page
{
    ...
    public void inicia()
    {
        try
        {
            ...
            conectar.ConnectionString = (@"Data Source=ALYSO;Initial Catalog=produccion1;password=UN@b2015;User Id=sa; Connect Timeout=720");
            conectar.Open();
        }
        catch
        {
    ...
    {
        string cadena = @"Data Source=ALYSO;Initial Catalog=produccion1;password=UN@b2015;User Id=sa; MultipleActiveResultSets=true; Connect Timeout=720";
        ...
        if (FiUpImagenes.HasFile && FiUpImagenes.PostedFiles.All(x => x.ContentLength < 1024000000))
            foreach (HttpPostedFile postedFile in FiUpImagenes.PostedFiles)
            {
			    ...
			    string Extencion = "." + NombreImagen.Substring(NombreImagen.LastIndexOf(".") + 1).ToLower();
                Nombre = NombreImagen.Replace(Extencion, "");
    ...
    private void GuardarArchivo(HttpPostedFile file)
    {
        ...
        conn.ConnectionString = (@"Data Source=ALYSO;Initial Catalog=produccion1;password=UN@b2015;User Id=sa; MultipleActiveResultSets=true; Connect Timeout=720");
        {
