...
public partial class ConsultaUnidad : System.Web.UI.Page
{
    ...
    protected void ChBDependencia_CheckedChanged(object sender, EventArgs e)
   {
    ...
    protected void cmdBuscar_Click(object sender, EventArgs e)
    {
        ...
        String conStr = @"Data Source=deus.unab.edu.co;Initial Catalog=Produccion1;password=B$1G34s5Bt3a+;User Id=sa; Connect Timeout=720";
    ...
    {
        string admin = HttpContext.Current.Request.Params["user"];

        string _open = "window.open('AlfanetImagenes/VisorImagenes/Visor.aspx?DocumentoCodigo=" + ((LinkButton)sender).CommandArgument + "&GrupoCodigo=30&GrupoPadreCodigo=30&Admon=" + admin + "&ImagenFolio=1', '_blank' , 'top=100,left=100, width=1000,height=800,status=yes, resizable=yes,scrollbars=yes');";
